...
;Variables
  ...
  !define PRODUCT_NAME "Electrum-Radiocoin"
  !define PRODUCT_WEB_SITE "https://github.com/c4pt000/electrum-radiocoin"
  !define PRODUCT_PUBLISHER "Radiocoin"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/ElectrumX-Radiocoin-setup.exe"
...
Section "Uninstall"
  ...
  DeleteRegKey HKCU "Software\Classes\radiocoin"
