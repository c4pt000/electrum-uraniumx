...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -D__ANDROID_API__=21 -I/opt/android/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/arm-linux-androideabi -I/home/user/wspace/electrum/.buildozer/android/platform/build-armeabi-v7a/build/python-installs/Electrum_Radiocoin/include/python3.7" ],
  CPPINCLUDES => [  ],
  CXX => "/usr/bin/ccache /opt/android/android-ndk-r22b/toolchains/llvm/prebuilt/linux-x86_64/bin/clang++ -target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC",
  CXXFLAGS => [ "-target armv7a-linux-androideabi21 -fomit-frame-pointer -march=armv7-a -mfloat-abi=softfp -mfpu=vfp -mthumb -fPIC" ],
  HASHBANGPERL => "/usr/bin/env perl",
  LDFLAGS => [ "  -L/home/user/wspace/electrum/.buildozer/android/platform/build-armeabi-v7a/build/libs_collections/Electrum_Radiocoin/armeabi-v7a" ],
  LDLIBS => [ "-lm" ],
  PERL => "/usr/bin/perl",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  --sysroot=\$(ANDROID_NDK_HOME)/sysroot",
  ...
  cpuid_obj => "mem_clr.o",
  cxxflags => "-std=c++11 -pthread  --sysroot=\$(ANDROID_NDK_HOME)/sysroot",
  defines => [  ],
