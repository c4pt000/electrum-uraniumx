...
# the data
Cache.register('._widgets', timeout=0)
...
class ElectrumWindow(App):
    ...
    def init_ui(self):
        ...
        #Cache.append('._widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('._widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "./electrum/gui/icons/..png"
    ...
    def format_fee_rate(self, fee_rate):
        ...
        return format_fee_satoshis(fee_rate/1000) + ' geiger/byte'
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-URX', message,
                            app_icon=icon, app_name='Electrum-URX')
        except ImportError:
