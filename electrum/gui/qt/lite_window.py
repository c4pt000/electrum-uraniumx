...
try:
    ...
    print "You need to have PyQT installed to run Electrum-URX in graphical mode."
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.setWindowTitle("Electrum-URX")
    ...
    def set_balances(self, btc_balance):
        ...
        self.setWindowTitle("Electrum-URX %s - %s %s" % (electrum_version, amount, unit))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        ...
        self.setWindowTitle("Electrum-URX - " + _("Receive Dogecoin payment"))
