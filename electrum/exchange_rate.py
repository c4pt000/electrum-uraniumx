...
class UraniumXAverage(ExchangeBase):
...
class UraniumXtoyou(ExchangeBase):
...
class UraniumXVenezuela(ExchangeBase):
...
class LocalUraniumXs(ExchangeBase):
...
class MercadoUraniumX(ExchangeBase):
